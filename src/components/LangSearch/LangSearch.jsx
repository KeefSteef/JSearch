...
function LangSearch() {
    ...
    return (
        <div ref={boxRef} onClick={(event) => event.stopPropagation()}>
            <div className="search_input" onClick={(event) => {
            ...
            {isTouched && 
                <div className={cls.search_box_container}>
                    ...
                    {mockData.map(option => {
                        return <li key={v4()}>
                            <LangOption lang={option.value} onClickHandler={() => {}}>{option.label}</LangOption>
                        </li>
                    })}
                    </Select>
                </div>
...
//   function LangSearch(props) {
//     return (
//         <div>
//             <SearchLangInput/>
//            <div className={cls.search_container}>
//             <div className={cls.selected_langs}>
//                 <Badge>PHP</Badge>
//                 <Badge>JavaScript</Badge>
//                 <Badge>C#</Badge>
//             </div>
